...
DECLARE_FUNCTION(MH::Monster, AI_Interpreter, 0x1413339d0, longlong*, longlong, ulonglong, undefined8)
// 45 33 F6 40 32 FF 44 89 75 67 4D 8B E0   (15.10)

DECLARE_FUNCTION(MH::Monster, ProcessTHKSegment, 0x141339d00, int, void*, int*, void*)
...
DECLARE_FUNCTION(MH::ActionController, DoAction, 0x14026a8e0, bool, void*, ActionInfo*)
...
DECLARE_FUNCTION(MH::Resource, LoadResource, 0x14223ef10, void*, void*, void*, char*, char)
DECLARE_FUNCTION(MH::Resource, TryUnloadResource, 0x1422422b0, void, void* sMhResource, void* instance)

DECLARE_POINTER(MH::Resource, void**, StaticExePointer, 0x145183f40)
...
DECLARE_FUNCTION(MH::Gimmick, GenNew, 0x1402cbe50, void, void*, int, int, float*, u64, int)
...
DECLARE_FUNCTION(MH::GUI, DisplayAlert, 0x1418e7da0, void, const char*)
DECLARE_FUNCTION(MH::GUI, DisplayMessageWindow, 0x141af75b0, void, void*, const char*, void*, float*, u8)
